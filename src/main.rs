...
use std::str::FromStr;
use brain::{calculate_position, generate_pgn, find_move, count, pruned, INFINITY};
...
struct LogData {
    pub depth: u8,
    pub max_iterative_deepening_depth: u8,
    pub average_time_per_move: u128,
    pub max_game_length: i32,
    pub final_game_length: i32,
    pub initial_fen: String,
    pub final_fen: String,
    pub final_pgn: String,
